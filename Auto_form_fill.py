...
def send_email():
    ...
    if (newark < datetime.date(2023,6,30))  & (newark > datetime.date(2023,3,20)):
        ...
        email.send_keys("singhals912@gmail.com")
        phone.send_keys("765-775-3587")
        permitclass.send_keys("D")
        driverlicense.send_keys("S44906840004941")
        validationnum.send_keys("16161")
    ...
    if (newark < datetime.date(2023,3,31)) or (lodi < datetime.date(2023,3,31)) or (wayne < datetime.date(2023,3,31)):
        ...
        smtp_server.login('singhals912@gmail.com', 'okdrfksltnfmdamz')
        # Send the email
